...
What do they all have in common? I want to touch them, dammit! So here's a hypothesis: design winners in music depend on the tactile sense. 
...
The upshot is <a target="_blank" href="https://chrome.google.com/webstore/detail/leppard/elinjnnjbogbjikhnkebppfedankbdkk">Leppard</a>, a Chrome extension that provides an alternate view of Spotify playlists. If you use __play.spotify__ just click the leppard icon in the address bar to toggle between the normal view and the leppard view. The design reinforces touch/hear by (1) devoting plenty of real estate to controlling what's playing and (2) encouraging use of keyboard shorcuts.
